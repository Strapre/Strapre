      ...
      <div className="w-full md:w-[90%] md:max-w-[1750px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500">Website: <a href="https://strapre.vercel.app" className="underline text-blue-600">https://strapre.vercel.app</a></p>
          </div>
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <section>
              ...
              <ul className="text-gray-700 space-y-1">
                <li><strong>Email:</strong> <a href="mailto:legal@strapre.com" className="text-blue-600 underline">legal@strapre.com</a></li>
